...
async function getRandomMeal()
{
    ...
    const randomMeal = respDados.meals[0];
...
function addMeal(mealData,random=false)
{
    ...
    meal.innerHTML=` 
            <div class="refeicao-header">
                ${random?`<span class="aleatorio"> Legumes Cenouras </span>         `:''}
            ...
            <div class="refeicao-body">
                ...
                <button class="fav-btn">                 <!--i.fas.fa-heart   shortcut para botao coracao-->
    ...
    const btn = meal.querySelector(".refeicao-body .fav-btn");
